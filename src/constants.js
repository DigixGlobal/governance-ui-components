...
export const ETHERSCAN_BALANCE_URL =
  (process.env.ENVIRONMENT === 'production' && 'https://etherscan.io/address/') ||
  (process.env.ENVIRONMENT === 'kovan' && 'https://kovan.etherscan.io/address/') ||
